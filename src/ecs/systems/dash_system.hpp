...
/// For entities with DashChainTalent, a dash from neutral grants a
/// DashFollowUp token that allows one cooldown-bypassing second dash —
/// unless the melee system spends the token on a 360-degree dash-spin
/// first.
